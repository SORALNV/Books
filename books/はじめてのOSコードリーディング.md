...
>>> PDP-11/40は専用のI/Oバスを持たずにUnibusという18ビットのアドレスバスを持つバスを入出力に用います。PDP11/40や周辺デバイスのレジスタメモリの最上位8Kバイトにマッピングし、メモリ操作を行うのと同様の方法でそれらのレジスタを操作します。これをMEemoryMapped I/Oと呼びます。
